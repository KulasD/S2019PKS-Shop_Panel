			...
			<div id="main_content">
				...
				<div class="half_width">
					...
					<div class="bordered_div_no_padding">
						...
						?>
						<div class="row" style="border:0px"><div class="half_row">Dane do dostawy:</div>	<div class="half_row_right"><input class="tx" type="text" name="imienazwisko" value="<?php echo "".$adres_[0]." ".$adres_[1]."";?>"/></div></div>
						
						<div class="row" style="border:0px"><div class="half_row"></div>					<div class="half_row_right"><input class="tx" type="text" name="telefon" value="<?php echo "".$adres_[6]."";?>"/></div></div>
						
						<div class="row" style="border:0px"><div class="half_row"></div>					<div class="half_row_right"><input class="tx" type="text" name="adres" value="<?php echo "".$adres_[3]."";?>"/></div></div>
						...
						<div class="row"><div class="half_row"></div>										<div class="half_row_right kontakt"><div class="kontakt_h_l">E-mail:</div><input class="tx" style="width:60%;" type="text" name="email"  value="<?php echo "".$dane_[3]."";?>"/></div></div>
